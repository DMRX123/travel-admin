// lib/supabase.js - FINAL FIXED VERSION
...
const getSupabaseUrl = () => {
  ...
  // During build on Vercel, use placeholder
  if (process.env.VERCEL_ENV === 'preview' || process.env.VERCEL_ENV === 'production') {
    return 'https://xeymfzwxjurwbezgwdef.supabase.co';
  }
...
const getSupabaseAnonKey = () => {
  ...
  if (process.env.VERCEL_ENV === 'preview' || process.env.VERCEL_ENV === 'production') {
    return 'sb_publishable_hugKMF1Hkj3WkC7GoAD3gA_vhCYVqbj';
  }
