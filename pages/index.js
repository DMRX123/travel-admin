        ...
        <section className="container mx-auto px-4 py-8 md:py-12">
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-white/80">Real-time fare • GPS tracking • Professional drivers • 24/7 service</p>
            </motion.div>
            ...
            <div className="grid lg:grid-cols-2 gap-8">
              ...
              >
                ...
                <div className="grid grid-cols-2 md:grid-cols-5 gap-3 mb-6">
                  {Object.entries(vehicleRates).map(([key, rate]) => (
                    <motion.button
                      ...
                      className={`p-3 rounded-xl text-center transition-all ${vehicle === key ? 'bg-gradient-to-r from-orange-500 to-red-500 text-white shadow-lg' : 'bg-white/10 text-white/80 hover:bg-white/20'}`}
                    >
                ...
                <div className="flex gap-4">
                  <button
                    ...
                    className="flex-1 bg-white/20 text-white py-3 rounded-xl font-semibold hover:bg-white/30 transition disabled:opacity-50"
                  >
                ...
                {showFare && fare > 0 && (
                  ...
                  >
                    <div className="flex justify-between items-center">
                      <div>
                        <p className="text-white/80">Estimated Fare</p>
                        <p className="text-3xl font-bold text-green-400">₹{fare.toFixed(2)}</p>
                      </div>
                      <div className="text-right">
                        <p className="text-white/80">Distance: {distance.toFixed(1)} km</p>
                        <p className="text-white/80">Duration: {duration}</p>
                      </div>
                    </div>
                  </motion.div>
                )}
              ...
              <motion.div
                initial={{ opacity: 0, x: 30 }}
                animate={{ opacity: 1, x: 0 }}
                className="bg-white/10 backdrop-blur-xl rounded-2xl p-4 border border-white/20 h-[500px] overflow-hidden"
              >
                <div className="text-white text-sm mb-2">📍 Route Preview</div>
                <div 
                  ref={(el) => {
                    ...
                    <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 hover:bg-white/20 transition-all cursor-pointer">
                      <div className="flex justify-between items-center">
                        <div>
                          ...
                          <div className="text-sm text-white/60">{route.distance} | {route.time}</div>
                        </div>
                ...
                >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-white/60">{testimonial.city}</p>
                    </div>
                  </div>
                </motion.div>
              ))}
